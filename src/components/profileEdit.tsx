...
const ProfileEdit: React.FC<ProfileEditProps> = ({ modeChange }) => {
  ...
  return (
    <div className='h-full flex absolute '>
      <div className="w-5/6 sm:max-lg:w-4/5 lg:w-[500px] min-h-[450px] lg:my-28 p-10 bg-Background/Bottom bg-[url('assets/particle.svg')]  bg-center bg-cover text-white rounded-xl shadow-lg relative border-2 border-Primary/Dark">
          ...
          <div className='flex-shrink-0 flex items-center'>
            <div className='relative mr-2'>
              <img
                ...
                onClick={() =>
                  modeChange === 'editprofile' && document.getElementById('imageUpload')?.click()
                }
              />
              {modeChange === 'editprofile' && (
                <input
