...
const ButtonShare: React.FC = () => {
  ...
  return (
    <div className='flex justify-center w-full'>
      <button
        className='bg-Background/Bottom border-2 h-40 mx-6 border-Primary/Dark px-6 py-4 w-full flex items-center justify-between rounded-3xl shadow-md lg:w-1/2 sm:max-lg:rounded-3xl lg:rounded-b-3xl sm:max-lg:mx-10 lg:mt-0
      ...
      >
        <div className='inline-block -ml-2 -mt-4  sm:max-lg:-mt-4 lg:-mt-2 sm:max-md:-ml-2 md:ml-4'>
          <img
            src={avatarUrl || ''}
            alt='Profile Icon'
        ...
        {/* Share Text Section */}
        <div className='bg-Background/Middle inline-block -mt-2 py-4 pl-4 rounded-3xl h-14 w-4/5 marker:sm:max-lg:-mt-2 lg:mt-0'>
