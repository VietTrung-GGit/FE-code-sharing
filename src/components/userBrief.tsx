...
const UserBrief: React.FC<UserBriefProps> = ({ userData, group, project, section, role }) => {
        ...
        <div className='flex flex-row w-full items-center lg:space-x-4 space-x-2'>
          ...
          {homeuser && homeuser._id !== user._id && (
            <button
              ...
              ${isFollowing ? 'bg-Accent/Target  hover:bg-red-400' : 'bg-white text-Accent/Target hover:bg-Accent/Target hover:'}`}
