function Hero() {
  return (
    <div className="h-[670px] bg-Background/Bottom bg-[url('backgroundeffect.png')] bg-no-repeat bg-center bg-cover text-center w-full mt-0 p-2 relative border-Primary/Dark border-solid box-border border-2 rounded-b-3xl mb-28">
      <div className="grid grid-cols-2 place-items-center p-0 bg-[url('assets/particle.svg')] bg-no-repeat bg-center bg-cover">
        <div className="flex flex-col text-white pb-20 ml-20">
