...
<br></br>
<p className="text-l text-white m-6">Don't have an account? <a href="" className="font-bold">Sign up!</a></p>
<button className="w-32 h-10 rounded-xl bg-white text-xl text-Primary/Dark m-6">Sign in</button>
</div>
);
}
