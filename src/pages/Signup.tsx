          ...
          <div className="bg-Background/Bottom bg-[url('assets/particle.svg')] bg-no-repeat bg-center bg-cover text-center w-full mt-0 p-10 relative border-Primary/Dark border-solid box-border border-2 rounded-b-3xl mb-28 sm:p-10 md:p-14 lg:p-16 xl:p-20">
            <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center'>
              ...
              <input
                type='text'
                placeholder='Email'
                className='bg-inputbox-Sign rounded-3xl p-3 w-11/12 text-l my-6 md:w-2/3 lg:w-1/2 xl:w-1/3'
                name='email'
              ...
              {/* Submit Button */}
              <button className='transition-colors duration-300 ease-in-out w-32 h-10 rounded-xl bg-Accent/Target text-xl text-white hover:bg-white hover:text-Accent/Target'>
                Sign up
              </button>
            </form>
          </div>
