          ...
          {type === undefined && (
            <>
              <div className='mb-5'>
                ...
                >
                  <button
                    className='text-lg bg-Primary/Light text-Primary/Dark rounded-3xl font-semibold px-4 py-1 w-28 flex flex-row justify-center items-center'
              ...
              {isDropdownFilterOpen && (
                <div className='absolute left-[400px] top-[360px] w-28 bg-Primary/Light border rounded-3xl shadow-lg z-10'>
                  <ul className='py-1 my-3 ml-2'>
                    <li>
                      <button
                        className='block px-4 py-2 text-lg text-Primary/Dark font-semibold hover:bg-Background/Middle w-full text-left flex flex-row gap-4'
